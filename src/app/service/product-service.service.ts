...
export class ProductServiceService {
  ...
  // }
  // }
  data: IProduct[] = [{ id: 1, catId: 2, name: "Back to the Future", description: "unleash sexy e-business", image: "SitAmetEros.tiff", price: 9601, stock: 84, featured: true, active: true, discount: false },
  ...
  { id: 50, catId: 2, name: "Live Music", description: "engineer sticky methodologies", image: "AliquamLacus.tiff", price: 8360, stock: 65, featured: true, active: true, discount: false },
  ...
  { id: 100, catId: 3, name: "The Bloody Olive", description: "unleash next-generation bandwidth", image: "VolutpatSapien.jpeg", price: 1417, stock: 26, featured: false, active: false, discount: true }];
}
